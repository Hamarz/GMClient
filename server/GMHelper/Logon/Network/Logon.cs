    ...
    public class Logon
    {
        ...
        public bool Start(string host, int port, string _username, string password)
        {
            try
            {
                ...
                Console.WriteLine($"{_username} : {password}");
        ...
        private void HandleSendChallenge()
        {
            ...
            packetWriter.Write((UInt16)(username.Length + 30));
            ...
            packetWriter.Write(BitConverter.ToUInt32((tcpClient.Client.LocalEndPoint as IPEndPoint).Address.GetAddressBytes(), 0));
        ...
        private void HandleSendServerChallenge(PacketReader reader)
        {
            ...
            Console.WriteLine(securityFlags);
            ...
            switch (errorResult)
            {
                case AuthResult.WOW_SUCCESS:
                    ...
                    // x is equal to sha1 hash of server sent salt and our passwordhash username:password
                    ...
                    //S = ((_B - k * (_N - _g.ModPow(x, _N))) % _N).ModPow(a + (u * x), _N);
                    ...
                    Console.WriteLine(m1Hash.Length);
                    ...
                    packetWriter.Write(new byte[20]); // Crc hash
                    packetWriter.Write((byte)0); // Number of keys
                    packetWriter.Write((byte)0); // Security Flags
